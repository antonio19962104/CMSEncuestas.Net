    ...
    public class Documentacion
    {
        ...
        public static Doc GetBussinessLayerDocumentation()
        {
            try
            {
                ...
                string path = Path.GetFullPath(@"C:\Antonio Projects\CMSEncuestas.Net\CMSEncuestas\BL\bin\Debug\BL.xml");
        ...
        public static Doc GetDataLayerDocumentation()
        {
            try
            {
                string xmlInputData = string.Empty;
                string xmlOutputData = string.Empty;
                string path = Path.GetFullPath(@"C:\Antonio Projects\CMSEncuestas.Net\CMSEncuestas\DL\bin\Debug\DL.xml");
                xmlInputData = File.ReadAllText(path);
        ...
        public static Doc GetModelLayerDocumentation()
        {
            try
            {
                string xmlInputData = string.Empty;
                string xmlOutputData = string.Empty;
                string path = Path.GetFullPath(@"C:\Antonio Projects\CMSEncuestas.Net\CMSEncuestas\ML\bin\Debug\ML.xml");
                xmlInputData = File.ReadAllText(path);
        ...
        public static Doc GetPresentationLayerDocumentation()
        {
            try
            {
                string xmlInputData = string.Empty;
                string xmlOutputData = string.Empty;
                string path = Path.GetFullPath(@"C:\Antonio Projects\CMSEncuestas.Net\CMSEncuestas\PL\bin\Debug\PL.xml");
                xmlInputData = File.ReadAllText(path);
